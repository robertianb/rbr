...
(
    ...
    maturityUnit                   VARCHAR2(1)            not null
        constraint CKC_MATURITYUNIT_LEVELLED check (
            maturityUnit in ('d','w','m','y','D','W','M','Y')),
...
(
    ...
    priceType                      VARCHAR2(16)           default 'TRADING' not null
        constraint CKC_PRICETYPE_DIVIDEND check (
            priceType in ('TRADING','VALIDATION')),
...
(
    ...
    dataChangeType                 VARCHAR2(1)            not null
        constraint CKC_DATACHANGETYPE_DATACHAN check (
            dataChangeType in ('I','U','D')),
...
(
    ...
    roundingThreshold              FLOAT                  default 0.51 null    
        constraint CKC_ROUNDINGTHRESHOLD_AUTOHEDG check (
            roundingThreshold is null or (roundingThreshold between 0.51 and 1)),
    roundingStepInLots             INTEGER                default 1 null    ,
    hedgePriceMode                 VARCHAR2(16)           null    
        constraint CKC_HEDGEPRICEMODE_AUTOHEDG check (
            hedgePriceMode is null or (hedgePriceMode in ('RELATIVE','ABSOLUTE'))),
...
(
    ...
    functionDescription            VARCHAR2(255)          null    ,
...
(
    ...
    interpolationMode              VARCHAR2(16)           not null
        constraint CKC_INTERPOLATIONMODE_AUTOBIAS check (
            interpolationMode in ('LINEAR','HYPERBOLIC')),
...
(
    ...
    context                        VARCHAR2(32)           default 'DEFAULT' not null,
    priceType                      VARCHAR2(16)           default 'TRADING' not null
        constraint CKC_PRICETYPE_VOLATILI check (
            priceType in ('TRADING','VALIDATION')),
    ...
    maturityUnit                   VARCHAR2(1)            null    
        constraint CKC_MATURITYUNIT_VOLATILI check (
            maturityUnit is null or (maturityUnit in ('d','w','m','y','D','W','M','Y'))),
...
(
    ...
    way                            VARCHAR2(1)            null    
        constraint CKC_WAY_DEALINGT check (
...
(
    ...
    dataType                       VARCHAR2(16)           not null
        constraint CKC_DATATYPE_PRICINGD check (
            dataType in ('VOLATILITY','DIVIDEND','RATE','REPO','YIELD','TAX_CREDIT')),
    ulId                           VARCHAR2(128)          not null,
...
(
    ...
    way                            VARCHAR2(1)            null    
        constraint CKC_WAY_PENDINGE check (
            way is null or (way in ('B','S'))),
    quantity                       INTEGER                null    ,
    price                          FLOAT                  null    ,
    timestamp                      TIMESTAMP(3)           null    ,
    ...
    executionState                 VARCHAR2(1)            not null
        constraint CKC_EXECUTIONSTATE_PENDINGE check (
...
(
    ...
    way                            VARCHAR2(1)            not null
        constraint CKC_WAY_DEPTHSNA check (
            way in ('2','B','S')),
...
(
    ...
    dataType                       VARCHAR2(16)           not null
        constraint CKC_DATATYPE_PDVHISTO check (
            dataType in ('VOLATILITY','DIVIDEND','RATE','REPO','YIELD','TAX_CREDIT')),
    version                        VARCHAR2(32)           null    ,
    timestamp                      TIMESTAMP(3)           null    ,
...
-- ============================================================
--   Table : OptionMaturityTime                                
-- ============================================================
create table OptionMaturityTime
(
    market                         VARCHAR2(32)           not null,
    marketUlId                     VARCHAR2(128)          not null,
    maturityTime                   VARCHAR2(6)            null    ,
    timezone                       VARCHAR2(125)          null    ,
    constraint PK_OPTIONMATURITYTIME primary key (market, marketUlId)
)
/
...
(
    ...
    type                           VARCHAR2(16)           default 'NORMAL' null    
        constraint CKC_TYPE_SPOTPROC check (
            type is null or (type in ('NORMAL','SYNTHETIC'))),
...
(
    ...
    type                           VARCHAR2(32)           null    
        constraint CKC_TYPE_BROKER check (
            type is null or (type in ('BROKER','COUNTERPARTY','INTERNAL_COUNTERPARTY'))),
...
(
    ...
    ruleType                       VARCHAR2(64)           not null
        constraint CKC_RULETYPE_MARKETMA check (
            ruleType in ('FULL_MM','QUOTE_RESPONSE')),
    ruleParameters                 VARCHAR2(1024)         null    ,
    underPerfThreshold             FLOAT                  not null
        constraint CKC_UNDERPERFTHRESHOL_MARKETMA check (
            underPerfThreshold between 0 and 1),
...
(
    ...
    execType                       VARCHAR2(1)            null    
        constraint CKC_EXECTYPE_TRADEBOO check (
            execType is null or (execType in ('C','D'))),
    ...
    way                            VARCHAR2(1)            null    
        constraint CKC_WAY_TRADEBOO check (
            way is null or (way in ('2','B','S'))),
...
(
    ...
    orderId                        VARCHAR2(128)          null    ,
    way                            VARCHAR2(1)            null    
        constraint CKC_WAY_FOREXEXE check (
            way is null or (way in ('2','B','S'))),
    quantity                       INTEGER                null    ,
    price                          FLOAT                  null    ,
    timestamp                      TIMESTAMP(3)           null    ,
    ...
    executionState                 VARCHAR2(1)            null    
        constraint CKC_EXECUTIONSTATE_FOREXEXE check (
            executionState is null or (executionState in ('n','c','u'))),
    productId                      VARCHAR2(128)          null    ,
    context                        VARCHAR2(32)           default 'DEFAULT' null    ,
    toHedge                        NUMBER(1)              default 0 null    ,
    sessionId                      VARCHAR2(64)           null    ,
...
(
    ...
    context                        VARCHAR2(32)           default 'DEFAULT' not null,
    priceType                      VARCHAR2(16)           default 'TRADING' not null
        constraint CKC_PRICETYPE_YIELDCUR check (
            priceType in ('TRADING','VALIDATION')),
    interpolationModel             VARCHAR2(16)           null    
        constraint CKC_INTERPOLATIONMODE_YIELDCUR check (
            interpolationModel is null or (interpolationModel in ('LINEAR','SPLINE'))),
...
(
    ...
    priceType                      VARCHAR2(32)           default 'AMOUNT' not null
        constraint CKC_PRICETYPE_COMBIPRO check (
            priceType in ('AMOUNT','PERCENT_DIRTY','PERCENT_CLEAN','YIELD')),
...
(
    ...
    exerciseStyle                  CHAR(1)                null    
        constraint CKC_EXERCICESTYLE_OPTIONPR check (
            exerciseStyle is null or (exerciseStyle in ('A','E'))),
    optionType                     CHAR(1)                not null
        constraint CKC_OPTIONTYPE_OPTIONPR check (
            optionType in ('C','P')),
...
(
    ...
    barrierType                    VARCHAR2(16)           not null
        constraint CKC_BARRIERTYPE_BARRIER check (
            barrierType in ('downAndIn','downAndOut','upAndOut','upAndIn')),
    ...
    payDateUnit                    VARCHAR2(1)            null    
        constraint CKC_PAYDATEUNIT_BARRIER check (
            payDateUnit is null or (payDateUnit in ('D','W','M','Y','d','w','m','y'))),
...
(
    ...
    strike                         FLOAT                  not null,
    exerciseStyle                  CHAR(1)                null    
        constraint CKC_EXERCICESTYLE_WARRANTP check (
            exerciseStyle is null or (exerciseStyle in ('A','E'))),
    optionType                     CHAR(1)                not null
        constraint CKC_OPTIONTYPE_WARRANTP check (
            optionType in ('C','P')),
    optionModel                    VARCHAR2(16)           not null,
    payoffDate                     TIMESTAMP(3)           null    ,
    isOtc                          NUMBER(1)              default 0 null    ,
...
(
    ...
    context                        VARCHAR2(32)           default 'DEFAULT' not null,
    way                            VARCHAR2(1)            not null
        constraint CKC_WAY_YESTERDA check (
            way in ('2','B','S')),
...
(
    ...
    context                        VARCHAR2(32)           default 'DEFAULT' not null,
    priceType                      VARCHAR2(16)           default 'TRADING' not null
        constraint CKC_PRICETYPE_REPORATE check (
            priceType in ('TRADING','VALIDATION')),
    dayCount                       VARCHAR2(32)           null    ,
    interpolationModel             VARCHAR2(16)           null    
        constraint CKC_INTERPOLATIONMODE_REPORATE check (
            interpolationModel is null or (interpolationModel in ('LINEAR','SPLINE'))),
    weekEndRule                    VARCHAR2(32)           null    ,
...
(
    ...
    context                        VARCHAR2(32)           default 'DEFAULT' not null,
    priceType                      VARCHAR2(16)           default 'TRADING' not null
        constraint CKC_PRICETYPE_VM check (
            priceType in ('TRADING','VALIDATION')),
    volatilityType                 VARCHAR2(16)           default 'FIXED' not null
        constraint CKC_VOLATILITYTYPE_VM check (
            volatilityType in ('FIXED','DEVFWD')),
    spotRef                        FLOAT                  null    ,
...
(
    ...
    context                        VARCHAR2(32)           default 'DEFAULT' not null,
    priceType                      VARCHAR2(16)           default 'TRADING' not null
        constraint CKC_PRICETYPE_DSV check (
            priceType in ('TRADING','VALIDATION')),
...
(
    ...
    context                        VARCHAR2(32)           default 'DEFAULT' not null,
    priceType                      VARCHAR2(16)           default 'TRADING' not null
        constraint CKC_PRICETYPE_SSV check (
            priceType in ('TRADING','VALIDATION')),
    calcDate                       TIMESTAMP(3)           null    ,
    spotRef                        FLOAT                  null    ,
...
(
    ...
    context                        VARCHAR2(32)           default 'DEFAULT' not null,
    priceType                      VARCHAR2(16)           default 'TRADING' not null
        constraint CKC_PRICETYPE_ADS check (
            priceType in ('TRADING','VALIDATION')),
    calcDate                       TIMESTAMP(3)           null    ,
    updateTimestamp                TIMESTAMP(3)           null    ,
...
(
    ...
    fixedVolValue                  FLOAT                  null    
        constraint CKC_FIXEDVOLVALUE_PRICINGS check (
            fixedVolValue is null or (fixedVolValue >= 0)),
...
(
    ...
    thresholdValue                 FLOAT                  null    ,
    thresholdUnit                  VARCHAR2(16)           null    
        constraint CKC_THRESHOLDUNIT_SPOT check (
            thresholdUnit is null or (thresholdUnit in ('IN_ABSOLUTE','IN_PERCENT'))),
    productId                      VARCHAR2(128)          null    ,
    publishDepth                   NUMBER(1)              default 0 null    ,
...
(
    ...
    orderId                        VARCHAR2(128)          null    ,
    way                            VARCHAR2(1)            null    
        constraint CKC_WAY_CASHEXEC check (
            way is null or (way in ('2','B','S'))),
    quantity                       INTEGER                null    ,
    price                          FLOAT                  null    ,
    timestamp                      TIMESTAMP(3)           null    ,
    ...
    marketData                     CLOB                   null    ,
    executionState                 VARCHAR2(1)            not null
        constraint CKC_EXECUTIONSTATE_CASHEXEC check (
            executionState in ('n','c','u')),
    productId                      VARCHAR2(128)          null    ,
    context                        VARCHAR2(32)           default 'DEFAULT' null    ,
    toHedge                        NUMBER(1)              default 0 null    ,
...
(
    ...
    floatingMaturityUnit           CHAR(1)                not null
        constraint CKC_FLOATINGMATURITYU_LIFFEMKT check (
            floatingMaturityUnit in ('D','M','Y','d','m','y')),
    spotRangeMax                   FLOAT                  not null,
    exerciseStyle                  CHAR(1)                not null
        constraint CKC_EXERCICESTYLE_LIFFEMKT check (
            exerciseStyle in ('A','E')),
...
(
    ...
    nakMaxRetries                  INTEGER                default 0 null    
        constraint CKC_NAKMAXRETRIES_AUTOMATO check (
            nakMaxRetries is null or (nakMaxRetries >= 0)),
    toHedge                        NUMBER(1)              default 0 null    ,
    ...
    baseRfqPriceToleranceType      VARCHAR2(16)           default 'IN_ABSOLUTE' null    
        constraint CKC_BASERFQPRICETOLER_AUTOMATO check (
            baseRfqPriceToleranceType is null or (baseRfqPriceToleranceType in ('IN_ABSOLUTE','IN_PERCENT'))),
...
(
    spotId                         VARCHAR2(128)          not null,
    thresholdUnit                  VARCHAR2(16)           null    
        constraint CKC_THRESHOLDUNIT_PRICINGS check (
            thresholdUnit is null or (thresholdUnit in ('IN_ABSOLUTE','IN_PERCENT'))),
    thresholdValue                 FLOAT                  null    ,
...
(
    ...
    version                        VARCHAR2(32)           default 'TRADING' not null,
    askShiftUnit                   VARCHAR2(16)           null    
        constraint CKC_ASKSHIFTUNIT_SHIFT check (
            askShiftUnit is null or (askShiftUnit in ('PRICE_ABS','PRICE_PCT','VOL_ABS','VOL_PCT','TICK'))),
    askShiftValue                  FLOAT                  null    ,
    bidShiftUnit                   VARCHAR2(16)           null    
        constraint CKC_BIDSHIFTUNIT_SHIFT check (
            bidShiftUnit is null or (bidShiftUnit in ('PRICE_ABS','PRICE_PCT','VOL_ABS','VOL_PCT','TICK'))),
    bidShiftValue                  FLOAT                  null    ,
    bidTickShift                   INTEGER                null    ,
    askTickShift                   INTEGER                null    ,
    ...
    priceShiftValue                FLOAT                  null    ,
    priceShiftUnit                 VARCHAR2(16)           null    
        constraint CKC_PRICESHIFTUNIT_SHIFT check (
            priceShiftUnit is null or (priceShiftUnit in ('PRICE_ABS','PRICE_PCT','VOL_ABS','VOL_PCT','TICK'))),
...
(
    ...
    context                        VARCHAR2(32)           default 'DEFAULT' not null,
    priceType                      VARCHAR2(16)           default 'TRADING' not null
        constraint CKC_PRICETYPE_DISCOUNT check (
            priceType in ('TRADING','VALIDATION')),
...
(
    ...
    context                        VARCHAR2(32)           default 'DEFAULT' not null,
    priceType                      VARCHAR2(16)           default 'TRADING' not null
        constraint CKC_PRICETYPE_BANKHOLI check (
            priceType in ('TRADING','VALIDATION')),
...
(
    ...
    context                        VARCHAR2(32)           default 'DEFAULT' not null,
    priceType                      VARCHAR2(16)           default 'TRADING' not null
        constraint CKC_PRICETYPE_FUTUREBA check (
            priceType in ('TRADING','VALIDATION')),
    basis                          FLOAT                  null    ,
...
(
    ...
    axeWay                         CHAR(1)                null    
        constraint CKC_AXEWAY_ISSUEPAR check (
            axeWay is null or (axeWay in ('B','S'))),
...
(
    ...
    orderId                        VARCHAR2(128)          null    ,
    way                            VARCHAR2(1)            null    
        constraint CKC_WAY_CEXECH check (
            way is null or (way in ('2','B','S'))),
    quantity                       INTEGER                null    ,
    price                          FLOAT                  null    ,
    timestamp                      TIMESTAMP(3)           null    ,
    ...
    marketData                     CLOB                   null    ,
    executionState                 VARCHAR2(1)            not null
        constraint CKC_EXECUTIONSTATE_CEXECH check (
            executionState in ('n','c','u')),
    productId                      VARCHAR2(128)          null    ,
    context                        VARCHAR2(32)           default 'DEFAULT' null    ,
    toHedge                        NUMBER(1)              default 0 null    ,
...
(
    ...
    orderId                        VARCHAR2(128)          null    ,
    way                            VARCHAR2(1)            null    
        constraint CKC_WAY_DEXECH check (
            way is null or (way in ('2','B','S'))),
    quantity                       INTEGER                null    ,
    price                          FLOAT                  null    ,
    timestamp                      TIMESTAMP(3)           null    ,
    ...
    marketData                     CLOB                   null    ,
    executionState                 VARCHAR2(1)            not null
        constraint CKC_EXECUTIONSTATE_DEXECH check (
            executionState in ('n','c','u')),
    productId                      VARCHAR2(128)          null    ,
    context                        VARCHAR2(32)           default 'DEFAULT' null    ,
    toHedge                        NUMBER(1)              default 0 null    ,
...
(
    ...
    pricingMethod                  VARCHAR2(16)           default 'ax+b' not null
        constraint CKC_PRICINGMETHOD_DELTAONE check (
            pricingMethod in ('ax+b','(x-b)/a','(b-x)/a')),
    generationTimestamp            TIMESTAMP(3)           null    ,
    importTimestamp                TIMESTAMP(3)           null    ,
    referenceSpot                  FLOAT                  null    ,
...
(
    ...
    orderId                        VARCHAR2(128)          null    ,
    way                            VARCHAR2(1)            null    
        constraint CKC_WAY_UNRESOLV check (
            way is null or (way in ('2','B','S'))),
    quantity                       INTEGER                null    ,
    price                          FLOAT                  null    ,
    timestamp                      TIMESTAMP(3)           null    ,
    ...
    marketData                     CLOB                   null    ,
    executionState                 VARCHAR2(1)            not null
        constraint CKC_EXECUTIONSTATE_UNRESOLV check (
            executionState in ('n','c','u')),
    productId                      VARCHAR2(128)          null    ,
    context                        VARCHAR2(32)           default 'DEFAULT' null    ,
    toHedge                        NUMBER(1)              default 0 null    ,
...
(
    ...
    context                        VARCHAR2(32)           default 'DEFAULT' not null,
    priceType                      VARCHAR2(16)           default 'TRADING' not null
        constraint CKC_PRICETYPE_PRODUCTA check (
            priceType in ('TRADING','VALIDATION')),
...
(
    ...
    context                        VARCHAR2(32)           default 'DEFAULT' not null,
    priceType                      VARCHAR2(16)           default 'TRADING' not null
        constraint CKC_PRICETYPE_BORROWIN check (
            priceType in ('TRADING','VALIDATION')),
...
(
    ...
    context                        VARCHAR2(32)           default 'DEFAULT' not null,
    priceType                      VARCHAR2(16)           default 'TRADING' not null
        constraint CKC_PRICETYPE_YCPOINT check (
            priceType in ('TRADING','VALIDATION')),
    maturityValue                  INTEGER                not null,
    maturityUnit                   VARCHAR2(1)            not null
        constraint CKC_MATURITYUNIT_YCPOINT check (
            maturityUnit in ('d','w','m','y','D','W','M','Y')),
    rate                           FLOAT                  null    ,
...
(
    ...
    context                        VARCHAR2(32)           default 'DEFAULT' not null,
    priceType                      VARCHAR2(16)           default 'TRADING' not null
        constraint CKC_PRICETYPE_RRPOINT check (
            priceType in ('TRADING','VALIDATION')),
    maturityValue                  INTEGER                not null,
    maturityUnit                   VARCHAR2(1)            not null
        constraint CKC_MATURITYUNIT_RRPOINT check (
            maturityUnit in ('d','w','m','y','D','W','M','Y')),
    rate                           FLOAT                  null    ,
...
(
    ...
    context                        VARCHAR2(32)           default 'DEFAULT' not null,
    priceType                      VARCHAR2(16)           default 'TRADING' not null
        constraint CKC_PRICETYPE_VMP check (
            priceType in ('TRADING','VALIDATION')),
    volatilityType                 VARCHAR2(16)           default 'FIXED' not null
        constraint CKC_VOLATILITYTYPE_VMP check (
            volatilityType in ('FIXED','DEVFWD')),
    maturity                       TIMESTAMP(3)           not null,
    strike                         FLOAT                  not null,
    volatility                     FLOAT                  null    ,
...
(
    ...
    context                        VARCHAR2(32)           default 'DEFAULT' not null,
    priceType                      VARCHAR2(16)           default 'TRADING' not null
        constraint CKC_PRICETYPE_FORWARDR check (
            priceType in ('TRADING','VALIDATION')),
    maturity                       TIMESTAMP(3)           not null,
    future                         FLOAT                  null    ,
    rolling                        FLOAT                  null    ,
...
(
    ...
    context                        VARCHAR2(32)           default 'DEFAULT' not null,
    priceType                      VARCHAR2(16)           default 'TRADING' not null
        constraint CKC_PRICETYPE_PRICINGC check (
            priceType in ('TRADING','VALIDATION')),
    productType                    VARCHAR2(16)           default '*' not null,
...
(
    ...
    currencyId                     VARCHAR2(3)            null    ,
    timestamp                      TIMESTAMP(3)           null    ,
    userComment                    VARCHAR2(512)          null    ,
    operationType                  VARCHAR2(32)           not null
        constraint CKC_OPERATIONTYPE_CASHOPER check (
            operationType in ('ADJUSTMENT','FEE','SETTLEMENT','PNL')),
...
(
    ...
    hedgeProperties                VARCHAR2(2000)         null    ,
...
(
    ...
    weight                         FLOAT                  null    ,
    way                            VARCHAR2(1)            null    
        constraint CKC_WAY_STRATEGY check (
            way is null or (way in ('2','B','S'))),
    price                          FLOAT                  null    ,
    name                           VARCHAR2(128)          null    ,
...
(
    ...
    context                        VARCHAR2(32)           default 'DEFAULT' not null,
    priceType                      VARCHAR2(16)           default 'TRADING' not null
        constraint CKC_PRICETYPE_DSVP check (
            priceType in ('TRADING','VALIDATION')),
    maturity                       TIMESTAMP(3)           not null,
    v0                             FLOAT                  null    ,
    forward                        FLOAT                  null    ,
...
(
    ...
    context                        VARCHAR2(32)           default 'DEFAULT' not null,
    priceType                      VARCHAR2(16)           default 'TRADING' not null
        constraint CKC_PRICETYPE_SSVP check (
            priceType in ('TRADING','VALIDATION')),
    maturity                       TIMESTAMP(3)           not null,
    forward                        FLOAT                  null    ,
    volAtmF                        FLOAT                  null    ,
...
(
    ...
    ulId                           VARCHAR2(128)          null    ,
    barrierType                    VARCHAR2(16)           not null
        constraint CKC_BARRIERTYPE_BARRIERV check (
            barrierType in ('downAndIn','downAndOut','upAndOut','upAndIn')),
    barrierLevel                   FLOAT                  not null,
    isTouched                      NUMBER(1)              null    ,
    touchTimestamp                 TIMESTAMP(3)           null    ,
    payDateValue                   INTEGER                null    ,
    payDateUnit                    VARCHAR2(1)            null    
        constraint CKC_PAYDATEUNIT_BARRIERV check (
            payDateUnit is null or (payDateUnit in ('D','W','M','Y','d','w','m','y'))),
    generationTimestamp            TIMESTAMP(3)           null    ,
    importTimestamp                TIMESTAMP(3)           null    ,
...
(
    ...
    orderId                        VARCHAR2(128)          null    ,
    way                            VARCHAR2(1)            null    
        constraint CKC_WAY_FEXECH check (
            way is null or (way in ('2','B','S'))),
    quantity                       INTEGER                null    ,
    price                          FLOAT                  null    ,
    timestamp                      TIMESTAMP(3)           null    ,
    ...
    marketData                     CLOB                   null    ,
    executionState                 VARCHAR2(1)            null    
        constraint CKC_EXECUTIONSTATE_FEXECH check (
            executionState is null or (executionState in ('n','c','u'))),
    productId                      VARCHAR2(128)          null    ,
    context                        VARCHAR2(32)           default 'DEFAULT' null    ,
    toHedge                        NUMBER(1)              default 0 null    ,
...
(
    ...
    archiveTimestamp               TIMESTAMP(3)           not null,
    execType                       VARCHAR2(1)            null    
        constraint CKC_EXECTYPE_TRABOOKH check (
            execType is null or (execType in ('C','D'))),
    tradeType                      VARCHAR2(32)           null    ,
    bookId                         VARCHAR2(128)          null    ,
    counterpartyId                 VARCHAR2(64)           null    ,
    ...
    location                       VARCHAR2(32)           null    ,
    way                            VARCHAR2(1)            null    
        constraint CKC_WAY_TRABOOKH check (
            way is null or (way in ('2','B','S'))),
    tradeRevision                  INTEGER                null    ,
    inputBy                        VARCHAR2(64)           null    ,
    legalEntity                    VARCHAR2(32)           null    ,
...
(
    ...
    context                        VARCHAR2(32)           default 'DEFAULT' not null,
    priceType                      VARCHAR2(16)           default 'TRADING' not null
        constraint CKC_PRICETYPE_ADSP check (
            priceType in ('TRADING','VALIDATION')),
    maturity                       TIMESTAMP(3)           not null,
    forward                        FLOAT                  null    ,
    volAtmF                        FLOAT                  null    ,
...
(
    ...
    archiveTimestamp               TIMESTAMP(3)           not null,
    way                            VARCHAR2(1)            not null
        constraint CKC_WAY_YESTPH check (
            way in ('2','B','S')),
    quantity                       INTEGER                not null,
    price                          FLOAT                  not null,
    delta                          FLOAT                  null    ,

 ...
 */
public class CreateTableAction extends TableAction {

    private PrimaryKeyConstraint primaryKey;

    public CreateTableAction(String tableName) {
        super(ActionCodes.CREATE_TABLE, new ArrayList<ColumnDefinition>(), tableName);
    }

    public CreateTableAction(String tableName, List<ColumnDefinition> columnDefinitions, PrimaryKeyConstraint primaryKey) {
    ...
    public CreateTableAction(String tableName, ColumnDefinition aColumn, ColumnDefinition... cols) {
        this(tableName);
        columns.add(aColumn);

-- ============================================================
--   Nom de la base   :  MCD                                   
--   Date de creation :  28/01/2013  16:06                     
-- ============================================================
...
(
    ...
    timezone                       VARCHAR2(125)          null    ,
    constraint PK_OPTIONMATURITYTIME primary key (mic, marketUlId)
)
/
...
(
    ...
    minMaturityUnit                VARCHAR2(1)            null    ,
    minMaturityValue               INTEGER                null    ,
    maxMaturityUnit                VARCHAR2(1)            null    ,
    maxMaturityValue               INTEGER                null    ,
...
(
    productId                      VARCHAR2(128)          not null,
    ssmPortfolioId                 VARCHAR2(64)           not null,
    locateId                       VARCHAR2(64)           not null,
    locateQty                      INTEGER                not null,
    constraint PK_LOCATE primary key (productId, ssmPortfolioId)
)
/
